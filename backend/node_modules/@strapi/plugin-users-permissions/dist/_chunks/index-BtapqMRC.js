...
const indexCQ0jOkIC = require("./index-CQ0jOkIC-C4oUQUND.js");
...
const index = require("./index-pmesAsoW.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexCQ0jOkIC.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexCQ0jOkIC.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexCQ0jOkIC.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-BtapqMRC.js.map
