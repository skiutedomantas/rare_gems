...
const index$1 = require("./index-C2n5fR1H.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-BXWLmzdx.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-BXWLmzdx.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-U1EqLqoJ.js.map
