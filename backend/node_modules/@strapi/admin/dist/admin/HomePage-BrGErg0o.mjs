...
import { b as Layouts, v as ContentBox } from './index-CQ0jOkIC.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-_UCA75ne.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-BrGErg0o.mjs.map
