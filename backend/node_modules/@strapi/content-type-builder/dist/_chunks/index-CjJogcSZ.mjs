...
const ListView$1 = lazy(() => import("./ListView-CsCdrbRA.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-CsCdrbRA.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-CjJogcSZ.mjs.map
