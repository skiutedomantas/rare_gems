import {
  require_groupBy
} from "./chunk-OFOQP7L2.js";
import {
  require_isEmpty
} from "./chunk-YGF2T2RX.js";
import {
  require_cloneDeep
} from "./chunk-PX3A3RDL.js";
import {
  require_baseForOwn,
  require_has,
  require_merge,
...
// node_modules/@strapi/admin/dist/admin/Permissions-D-z4OQkJ.mjs
...
var ConditionsButtonImpl = React.forwardRef(
  ({ onClick, className, hasConditions = false, variant = "tertiary" }, ref) => {
    const { formatMessage } = useIntl();
    return (0, import_jsx_runtime.jsx)(ButtonContainer, { $hasConditions: hasConditions, className, children: (0, import_jsx_runtime.jsx)(Button, { variant, startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$41, {}), onClick, ref, type: "button", children: formatMessage({
      id: "global.settings",
...
//# sourceMappingURL=chunk-ATM3YBG5.js.map
